...
**Data:** this folder contains the data utilized for both model training and evaluation purposes:
- `data/images` holds the image data employed for training.
- `data/validation` stores the outcomes of data validation processes. 
Run the jupyter notebook `data_validation.ipynb` to conduct an Explorative Data Analysis (EDA) of the image dataset.
