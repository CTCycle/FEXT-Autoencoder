...
call pip install keras==3.8.0 scikit-learn==1.6.1 scikit-image==0.25.1 opencv-python==4.11.0.86 
call pip install matplotlib==3.10.1 numpy==2.1.3 pandas==2.2.3 PySide6==6.9.0    
