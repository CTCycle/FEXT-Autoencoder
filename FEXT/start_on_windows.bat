...
:datanalysis
cls
start cmd /k "call conda activate %env_path% && jupyter notebook .\validation\image_dataset_validation.ipynb"
goto :main_menu
...
:inference
cls
call conda activate "%env_path%" && python .\inference\images_encoding.py
goto :main_menu
